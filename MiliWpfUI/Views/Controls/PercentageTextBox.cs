        ...
        protected override void SetMoneyTextBox(TextBox texbox)
        {
            ...
            texbox.GotFocus += delegate {
                ...
                if (setDecimal)
                {
                    ...
                    {
                        texbox.Text = "0,000";
                        texbox.Select(texbox.Text.Length - 2, 0);
                    }
                    else
                    {
                ...
                {
                    if (!(texbox.Text.Length > 4))
                    {
                        texbox.Text = "0,000";
                        texbox.Select(texbox.Text.Length - 4, 0);
                    }
                    else
                    {
                        texbox.Select(texbox.Text.Length - 4, 0);
